    ...
    var regexPattern: String {
        ...
        case .email:
            /*
             ...
             "username@domain..com",                  // contains consecutive dots(?!.*\.\.)
             ...
             "SELECT * FROM vapor",                   // not an email; contains spaces + SQL characters
             "scd2999045.1233422123@yahoo.com/sckiii   ",   // contains slash and spaces; path segments not allowed
            */
